...
public class SupplierAdapter extends ArrayAdapter<SupplierBean>{
	...
	public View getView( final int position,  View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			mHolder.tv_phone_info = (TextView)v.findViewById(R.id.tv_id_info);
			mHolder.tv_contact_info = (TextView)v.findViewById(R.id.tv_product_info);
		...
		if(mVendor != null){
			...
			mHolder.tv_id_info.setText(mVendor.getId());
	...
	class ViewHolder {
		public TextView tv_id_info,tv_product_info,tv_supplier_info,tv_phone_info,tv_contact_info,tv_address_info;
